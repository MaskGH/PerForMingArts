...
class HomeFestivalSlider extends GetView<HomeController> {
          ...
          child: CarouselSlider.builder(
              ...
              itemBuilder: (context, index, realIndex) {
                return GestureDetector(
                  onTap: () {
                    Get.toNamed(
                        '/detail/${controller.dbsFestival.value.db![index].mt20id}');
                  },
                  child: Image.network(
                    controller.dbsFestival.value.db?[index].poster! ?? "",
                    fit: BoxFit.fill,
